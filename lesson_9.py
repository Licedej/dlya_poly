...
plt.xlabel('Ось X')
plt.ylabel('Ось Y')
plt.title(r"$f(x) = \frac{x^a + a^b}{x^b}$")
plt.legend()
plt.grid()
plt.savefig(dir + '/les_9_1.svg', dpi=300)
plt.show()
...
plt.savefig(dir + '/les_9_2.svg', dpi=300)
plt.show()
...
plt.savefig(dir + '/les_9_3.svg', dpi=300)
plt.show()
...
plt.savefig(dir + '/les_9_4.svg', dpi=300)
plt.show()
...
plt.savefig(dir + '/les_9_4_2.svg', dpi=300)
plt.show()